...
function TSQLiteDatabase.Backup(TargetDB: TSQLiteDatabase; targetName: ansistring;
  sourceName: ansistring): integer;
var
  pBackup: TSQLiteBackup;
begin
  pBackup := Sqlite3_backup_init(TargetDB.DB, PAnsiChar(targetName),
    self.DB, PAnsiChar(sourceName));
