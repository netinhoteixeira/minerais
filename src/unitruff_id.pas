      ...
      2:begin
        if FoundComma = 0 then
          begin
            ...
            begin
              Dados.DatabaseSamples.ExecSQL('INSERT INTO raman (especie, '+
                'rruff_id, digito, direcao) VALUES ("'+EditNome.Text+'","'+
              ...
              Dados.DatabaseSamples.ExecSQL('INSERT INTO raman (especie, '+
                'rruff_id, digito, direcao) VALUES ("'+EditNome.Text+'","'+
                  EditSample_id.Text+'", "'+EditAmostras.Text+'","714 nm");');
              Dados.DatabaseSamples.ExecSQL('INSERT INTO raman (especie, '+
                'rruff_id, digito, direcao) VALUES ("'+EditNome.Text+'","'+
          ...
          begin
             ...
             begin
               ...
               begin
                 ...
                 Dados.DatabaseSamples.ExecSQL('INSERT INTO raman (especie, rruff_id,'+
                   'digito, direcao) VALUES ("'+EditNome.Text+'","'+
                     EditSample_id.Text+'", "'+TextoAmostras+'","714 nm");');
                 Dados.DatabaseSamples.ExecSQL('INSERT INTO raman (especie, rruff_id,'+
                   'digito, direcao) VALUES ("'+EditNome.Text+'","'+
                     EditSample_id.Text+'", "'+TextoAmostras+'","732 nm");');
                 Dados.DatabaseSamples.ExecSQL('INSERT INTO raman (especie, rruff_id,'+
                   'digito, direcao) VALUES ("'+EditNome.Text+'","'+
