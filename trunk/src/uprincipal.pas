...
uses
  ...
  StdCtrls, ExtCtrls, ComCtrls, DbCtrls, ExtDlgs, Buttons, BGRAPanel, BGRALabel,
  BGRALabelFX, RichMemo, uFormImpressao, uSelecionaBD, SQLite3mod, SQLite3tablemod,
  uBibliografia, UnitAjuda;
...
type
  ...
  TFormPrincipal = class(TForm)
    ...
    Nome: TBGRALabelFX;
    BGRALabelFXDensidade: TBGRALabelFX;
    BGRALabelFXDureza: TBGRALabelFX;
    BGRALabelFXSubclasse: TBGRALabelFX;
    BGRALabelFXGrupo: TBGRALabelFX;
    BGRALabelFXSubgrupo: TBGRALabelFX;
    BGRALabelFXClasse: TBGRALabelFX;
...
begin
   ...
   begin
    if (Dados.SQLite3DatasetGeral.active) then Dados.SQLite3DatasetGeral.applyupdates
      ...
      //usado para nao bugar quando o nome for editado
    Dados.SQLite3DatasetGeral.first;
...
begin
  ...
  begin
 // if (not dados.SQLite3DatasetGeral.Active) then  //nao precisa, se listbox tiver selecionado entao ja ta aberto
 // dados.SQLite3DatasetGeral.open();
